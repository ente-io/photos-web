module.exports = {
    ...
    CSP_DIRECTIVES: {
        ...
        'connect-src':
            "'self' https://*.ente.io http://localhost:8080 data: blob: https://ente-prod-eu.s3.eu-central-003.backblazeb2.com https://ente-prod-v3.s3.eu-central-2.wasabisys.com/ https://ente-staging-eu.s3.eu-central-003.backblazeb2.com/ ws://localhost:3000/ http://localhost:8700/",
        'base-uri ': "'self'",
        // to allow worker
        'child-src': "'self' blob:",
        'object-src': "'none'",
