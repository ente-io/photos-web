...
//                     it may have had multiple folder, but chose to upload
//                     to one album
...
//                 */
//                 await ImportService.setToUploadCollection(collectionName);
//             } else {
...
//             currentPromise,
//             async () =>
//                 await uploadFiles(filesWithCollectionToUploadIn, uploaderName)
//         );
//     };
