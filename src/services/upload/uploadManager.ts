...
//     private collectionsFilesUploadIn: Collection[] = [];
//     private uploadedFiles: EnteFile[] = [];
...
//         UploadService.setExistingCollection(existingCollections);
//         uploadService.setExistingFiles(
//             getUserOwnedNonTrashedFiles(existingFiles)
//         );
//     }
...
//             }
//             if (isElectron()) {
//                 if (watchFolderService.isSyncPaused()) {
...
//             const { fileUploadResult, uploadedFile, collectionUploadedIn } =
//                 await uploader(
//                     worker,
//                     fileWithCollection,
//                     this.uploaderName,
...
//             if (
//                 collectionsFilesUploadIn.findIndex(
//                     (c) => c.id === collectionUploadedIn.id
//                 ) === -1
//             ) {
//                 collectionsFilesUploadIn.push(collectionUploadedIn);
