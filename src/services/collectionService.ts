...
export const addToCollection = async (
    ...
    try {
        ...
        await HTTPService.post(
            `${API_ENDPOINT}/collections/add-files`,
            requestBody,
            null,
            {
                'X-Auth-Token': token,
...
export const restoreToCollection = async (
    ...
    try {
        ...
        await HTTPService.post(
            `${API_ENDPOINT}/collections/restore-files`,
            requestBody,
            null,
            {
                'X-Auth-Token': token,
...
export const moveToCollection = async (
    ...
    try {
        ...
        await HTTPService.post(
            `${API_ENDPOINT}/collections/move-files`,
            requestBody,
            null,
            {
                'X-Auth-Token': token,
...
export const removeFromCollection = async (
    ...
    try {
        ...
        await HTTPService.post(
            `${API_ENDPOINT}/collections/v2/remove-files`,
            request,
            null,
            { 'X-Auth-Token': token }
        );
...
export const deleteCollection = async (collectionID: number) => {
    try {
        ...
        await HTTPService.delete(
            `${API_ENDPOINT}/collections/v2/${collectionID}`,
            null,
            null,
            { 'X-Auth-Token': token }
        );
...
export const updateCollectionMagicMetadata = async (collection: Collection) => {
    ...
    await HTTPService.put(
        `${API_ENDPOINT}/collections/magic-metadata`,
        reqBody,
        null,
        {
            'X-Auth-Token': token,
...
export const renameCollection = async (
    ...
    await HTTPService.post(
        `${API_ENDPOINT}/collections/rename`,
...
export const shareCollection = async (
    ...
    try {
        ...
        await HTTPService.post(
            `${API_ENDPOINT}/collections/share`,
...
export const unshareCollection = async (
    ...
    try {
        ...
        await HTTPService.post(
            `${API_ENDPOINT}/collections/unshare`,
            shareCollectionRequest,
            null,
            {
                'X-Auth-Token': token,
...
export const createShareableURL = async (collection: Collection) => {
    try {
        ...
        const resp = await HTTPService.post(
            `${API_ENDPOINT}/collections/share-url`,
            createPublicAccessTokenRequest,
            null,
            {
                'X-Auth-Token': token,
...
export const deleteShareableURL = async (collection: Collection) => {
    try {
        ...
        await HTTPService.delete(
            `${API_ENDPOINT}/collections/share-url/${collection.id}`,
            null,
            null,
            {
                'X-Auth-Token': token,
