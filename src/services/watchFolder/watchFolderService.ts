...
//         ) {
//             if (isLivePhotoUploadAsset(uploadAsset)) {
...
//         uploadedFiles: EnteFile[],
//         failedFiles:FileWithCollection[],
...
//                     (collection) =>
//                         collection.id === uploadedFiles[0].collectionID
//                 );
...
//     ) {
//         if (uploadedFile.metadata.fileType === FILE_TYPE.LIVE_PHOTO) {
//             const imagePath = uploadedFile.metadata.imagePath;
//             const videoPath = uploadedFile.metadata.videoPath;
